...
{
    /// <summary>
    /// Stable identifier of the color (matched against <see cref="BlazorFullCalendarEvent.Color"/>).
    ...
    /// <c>BlazorFullCalendarEventColor</c>, so events created against the defaults need no migration.
    /// </summary>
